"""
gpt.py — Decoder-only Transformer language model (character-level).

Implements the full GPT architecture from scratch:
...
Trains on Tiny Shakespeare (~1MB) and generates new text.
